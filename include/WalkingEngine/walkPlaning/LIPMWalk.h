...
namespace GaitManager
{
    ...
    public:
        ...
        double LArm_R = LArm_Rdf, LArm_P = LArm_Pdf, LArm_elbow = LArm_elbowdf; //手臂关节角度
        ...
        void CubicSplineSixInit(Eigen::Vector6d *In, Matrix<double, 7, 1> *Out, double t, double alpha);
        ...
        Eigen::Vector6d cubicsplinePx_wF, cubicsplineAx_wF, 
            cubicsplinePy_wF, cubicsplineAy_wF, 		
            cubicsplinePyaw_wF, cubicsplineAyaw_wF; // world frame spline
        ...
        Eigen::Vector6d cubicsplineFootPx_wf, cubicsplineFootAx_wf, 
            cubicsplineFootPy_wf, cubicsplineFootAy_wf, 
            cubicsplineFootPz1_wf, cubicsplineFootAz1_wf, cubicsplineFootPz2_wf, cubicsplineFootAz2_wf, 

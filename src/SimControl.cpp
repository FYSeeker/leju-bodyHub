...
std_msgs::Float64MultiArray entityToSimOfIndex(std_msgs::Float64MultiArray entity)
{
  uint8_t i = 0;
...
std_msgs::Float64MultiArray simToEntityOfIndex(std_msgs::Float64MultiArray sim)
{
  uint8_t i = 0;
